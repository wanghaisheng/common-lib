 ...
 */
public final class UtilsFreshDml {

    private QueryRunner queryRunner = null;

    private static final Logger logger = LoggerFactory.getLogger(UtilsFreshDml.class);

    public UtilsFreshDml() {
    ...
    public List<DataRowsBean> getTableInfo(String tableName, ConfigBean configBean) {
        ...
        DataRowsBean dataRowsBean = null;
